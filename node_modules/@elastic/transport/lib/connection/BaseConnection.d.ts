...
import { ApiKeyAuth, BasicAuth, BearerAuth, HttpAgentOptions, UndiciAgentOptions, agentFn } from '@elastic/transport/lib/types';
import { kStatus, kDiagnostic, kCaFingerprint } from '@elastic/transport/lib/symbols';
...
export declare function stripAuth(url: string): string;
