import { Middleware, MiddlewareContext, MiddlewareNext } from '@elastic/transport/lib/middleware/types';
import { TransportResult } from '@elastic/transport/lib/types';
import { NativeErrorOptions } from '@elastic/transport/lib/errors';
