...
import { kCaFingerprint } from '@elastic/transport/lib/symbols';
import { Connection, ConnectionOptions, BaseConnection } from '@elastic/transport/lib/connection/index';
import { HttpAgentOptions, UndiciAgentOptions, agentFn, ApiKeyAuth, BasicAuth, BearerAuth, nodeFilterFn, nodeSelectorFn } from '@elastic/transport/lib/types';
