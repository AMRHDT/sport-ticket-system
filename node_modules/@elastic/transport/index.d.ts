...
import Diagnostic, { events } from '@elastic/transport/lib/Diagnostic'
import Transport from '@elastic/transport/lib/Transport'
import {
  BaseConnection,
  HttpConnection,
  UndiciConnection
} from '@elastic/transport/lib/connection/index'
import {
  WeightedConnectionPool,
  ClusterConnectionPool,
  CloudConnectionPool,
  BaseConnectionPool
} from '@elastic/transport/lib/pool/index'
