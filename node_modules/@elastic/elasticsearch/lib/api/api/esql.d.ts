...
import { kAcceptedParams } from '@elastic/elasticsearch/lib/symbols';
interface That {
    transport: Transport;
...
export default class Esql {
    ...
    /**
      ...
      */
    deleteDataSource(this: That, params: T.EsqlDeleteDataSourceRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.EsqlDeleteDataSourceResponse>;
    deleteDataSource(this: That, params: T.EsqlDeleteDataSourceRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.EsqlDeleteDataSourceResponse, unknown>>;
    deleteDataSource(this: That, params: T.EsqlDeleteDataSourceRequest, options?: TransportRequestOptions): Promise<T.EsqlDeleteDataSourceResponse>;
    /**
      ...
      */
    deleteDataset(this: That, params: T.EsqlDeleteDatasetRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.EsqlDeleteDatasetResponse>;
    deleteDataset(this: That, params: T.EsqlDeleteDatasetRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.EsqlDeleteDatasetResponse, unknown>>;
    deleteDataset(this: That, params: T.EsqlDeleteDatasetRequest, options?: TransportRequestOptions): Promise<T.EsqlDeleteDatasetResponse>;
    /**
    ...
    /**
      ...
      */
    getDataSource(this: That, params?: T.EsqlGetDataSourceRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.EsqlGetDataSourceResponse>;
    getDataSource(this: That, params?: T.EsqlGetDataSourceRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.EsqlGetDataSourceResponse, unknown>>;
    getDataSource(this: That, params?: T.EsqlGetDataSourceRequest, options?: TransportRequestOptions): Promise<T.EsqlGetDataSourceResponse>;
    /**
      ...
      */
    getDataset(this: That, params?: T.EsqlGetDatasetRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.EsqlGetDatasetResponse>;
    getDataset(this: That, params?: T.EsqlGetDatasetRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.EsqlGetDatasetResponse, unknown>>;
    getDataset(this: That, params?: T.EsqlGetDatasetRequest, options?: TransportRequestOptions): Promise<T.EsqlGetDatasetResponse>;
    /**
    ...
    /**
      ...
      */
    putDataSource(this: That, params: T.EsqlPutDataSourceRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.EsqlPutDataSourceResponse>;
    putDataSource(this: That, params: T.EsqlPutDataSourceRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.EsqlPutDataSourceResponse, unknown>>;
    putDataSource(this: That, params: T.EsqlPutDataSourceRequest, options?: TransportRequestOptions): Promise<T.EsqlPutDataSourceResponse>;
    /**
      ...
      */
    putDataset(this: That, params: T.EsqlPutDatasetRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.EsqlPutDatasetResponse>;
    putDataset(this: That, params: T.EsqlPutDatasetRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.EsqlPutDatasetResponse, unknown>>;
    putDataset(this: That, params: T.EsqlPutDatasetRequest, options?: TransportRequestOptions): Promise<T.EsqlPutDatasetResponse>;
    /**
