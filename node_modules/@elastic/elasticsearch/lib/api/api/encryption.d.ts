...
export default class Encryption {
    ...
    /**
      ...
      */
    reset(this: That, params: T.EncryptionResetRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.EncryptionResetResponse>;
    reset(this: That, params: T.EncryptionResetRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.EncryptionResetResponse, unknown>>;
    reset(this: That, params: T.EncryptionResetRequest, options?: TransportRequestOptions): Promise<T.EncryptionResetResponse>;
}
export {};
