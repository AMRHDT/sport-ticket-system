...
export default class Security {
    ...
    /**
      ...
      */
    cloneApiKey(this: That, params: T.SecurityCloneApiKeyRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.SecurityCloneApiKeyResponse>;
    cloneApiKey(this: That, params: T.SecurityCloneApiKeyRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.SecurityCloneApiKeyResponse, unknown>>;
    cloneApiKey(this: That, params: T.SecurityCloneApiKeyRequest, options?: TransportRequestOptions): Promise<T.SecurityCloneApiKeyResponse>;
    /**
